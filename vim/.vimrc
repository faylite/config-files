...
colorscheme luinnar " Some good ones, pablo / koehler / desert / slate
...
" Airline Settings
" ConEmu doesn't play nice with the fonts, so enable only in gui, placing in
" .gvimrc doesn't work
if has("gui_running")
	set encoding=utf-8
	let g:airline_powerline_fonts=1
	" Custom font for airline
